      ...
      <LampContainer className="!bg-[#181825]">
        ...
        >
          ...
          <div className="flex justify-center gap-8 mt-10">
            <a href="https://github.com/shwetarkadam/clipd" target="_blank" rel="noreferrer" className="font-mono text-xs text-[#6c7086] flex items-center gap-2 hover:text-[#bac2de] transition-colors no-underline">
